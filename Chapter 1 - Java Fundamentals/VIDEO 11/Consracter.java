...
public class Constracter {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        // 8. String(char[] value, int begin, int count, String enc) throws UnsupportedEncodingException
        String encodedString = new String(charArray, 0, 5, "UTF-8");
        System.out.println("8. Encoded String: '" + encodedString + "'");

        // 9. String(char[] value, String enc) throws UnsupportedEncodingException
        String encodedString2 = new String(charArray, "UTF-8");
        System.out.println("9. Encoded String 2: '" + encodedString2 + "'");
    }
}
