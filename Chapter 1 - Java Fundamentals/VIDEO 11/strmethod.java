...
public class strmethod {
    ...
    public static void main(String[] args) {
        ...
        String concatResult = "dalle".concat(" Mahesh");
        ...
        String[] limitedSplitArray = "Java,is,fun,with,limitationsbyd al le ok ".split(",", 2);
        ...
        int indexOfCharFromIndex = "dalle".indexOf('l', 4);
